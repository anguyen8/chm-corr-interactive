...
class Geometry(object):
    ...
    def initialize(cls, img_size):
        ...
        norm_grid1d = torch.linspace(-1, 1, cls.spatial_side).to(device)
        ...
        cls.feat_idx = torch.arange(0, cls.spatial_side).float().to(device)
    ...
    def transfer_kps(cls, confidence_ts, src_kps, n_pts, normalized):
        ...
        for idx, (x, y, src_kp, np) in enumerate(zip(prd_x, prd_y, src_kps, n_pts)):
            ...
            pads = (torch.zeros((2, max_pts - np)).to(device) - 2)
